...
const HeaderStyleTwo = function ({ SetToggleClassName, topbar, path }) {
  ...
  return (
    <>
      <header className={`ltn__header-area ltn__header-5 ltn__header-logo-and-mobile-menu-in-mobile ltn__header-logo-and-mobile-menu ${transparentLinks.includes(path) ? 'ltn__header-transparent' : ''}`}>
        ...
        >
          <Container>
            <Row>
              ...
              <Col className={`header-menu-column ${transparentLinks.includes(path) && (scroll < headerHeight) ? 'menu-color-white' : 'menu-color-black'}`}>
